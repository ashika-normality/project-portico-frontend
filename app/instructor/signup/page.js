...
const page = () => (
    <div className="w-full flex justify-center px-4 items-start min-h-screen py-16 bg-[url('/Assets/background-image-signup.webp')] bg-cover bg-center bg-no-repeat">
