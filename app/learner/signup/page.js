...
const Page = () => (
  <div className="w-full min-h-screen flex justify-center items-center bg-gray-100">
    <div className="flex w-full max-w-6xl min-h-[500px] bg-white rounded-lg shadow-lg overflow-hidden">
      ...
      <div className="w-1/2 flex flex-col justify-center px-10 py-6">
        <h1 className="font-raleway text-2xl font-bold text-primary text-center">
          Learner Sign Up
        </h1>
